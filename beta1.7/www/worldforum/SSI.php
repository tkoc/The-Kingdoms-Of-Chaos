...
function ssi_howManyOnline($output_method = 'echo')
{
	...
	echo '<b>', $return['num_guests'], '</b> ', $return['num_guests'] == 1 ? $txt['guest'] : $txt['guests'], ' and <b>', $return['num_users_online'], '</b> ', $return['num_users_online'] == 1 ? $txt['user'] : $txt['users'];
}
