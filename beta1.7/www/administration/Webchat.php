...
require_once ($GLOBALS['path_www_administration']."Webchat.class.inc.php");
require_once($GLOBALS['path_www_scripts']."isLoggedOn.inc.php");

	$webchat = new Webchat($database, $user);
	$body = $webchat->getAppletHTML();

//	templateDisplay($province, $body);
	AdminTemplateDisplay("Webchat for: <b>$user->username</b>",$user,$body);
