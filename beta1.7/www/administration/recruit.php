...
require_once ("RecruitPlayers.class.inc.php");

$recruit = new RecruitPlayers($GLOBALS['database'],$user->userID);
$recruit->getUserData();
//var_export($info);

$html = '<table cellpadding=5; cellspacing=0; border=0; style="width:100%">
			<TR class="subtitle"><TD class="TL">Province/User:</TD></TR>
			<TR bgcolor=#CCCCCC>
				<!-- Recruit details -->
				<TD class="TL">
				'./*$recruit->showUserData()*/"disabled".'
				</TD>
			</TR>
		</table>
';
