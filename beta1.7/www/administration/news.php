...
if ((intval($GLOBALS['user']->access) & $GLOBALS['constants']->USER_POST_NEWS) ) 
   $news = new GameNews($GLOBALS['database'],$user);
else die("tkoc.net");

AdminTemplateDisplay("News @ tkoc.net",$user,$news->handleInput($_POST));
