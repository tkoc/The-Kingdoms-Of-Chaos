...
$user = new User ($cId,$GLOBALS['database']);  // no cookie
...
$tekst = '
You are now logged out of tkoc.net administration.
';

AdminTemplateDisplay("You are now logged out, <b>$user->username</b>",false,$tekst . $index->html);
?>