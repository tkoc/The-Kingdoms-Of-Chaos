...
<?php
	...
	if( !class_exists("ElfAttackersMilitary")) {
		class ElfAttackersMilitary extends MilitaryBase {
			var $picture = "scripts/military/elf/ranger.gif";
			var $MilitaryConst = NULL;
			
			function ElfAttackersMilitary( $militaryID ) {
				...
				$ticks = 18;
				$cost = array("gold"=>650, "metal"=>0, "food"=>0);
				$strength = array("attack"=>4, "defense"=>1);
				$milConst = $GLOBALS['MilitaryConst'];
				$this->MilitaryBase($militaryID, "Rangers", $info ,$type, $ticks, $cost, $strength);
			}
