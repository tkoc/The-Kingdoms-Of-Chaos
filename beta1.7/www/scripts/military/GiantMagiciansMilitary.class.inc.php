...
<?php
	...
	if( !class_exists("GiantMagiciansMilitary")) {
		class GiantMagiciansMilitary extends MilitaryBase {
			var $picture = "wizards.gif";
			var $MilitaryConst = NULL;
			
			function GiantMagiciansMilitary( $militaryID ) {

				$this->MilitaryConst = $GLOBALS['MilitaryConst'];
				$ticks = 24;
				$info = "The more studious wizards have forgotten most of their military training by the time they are trained, which takes $ticks days. This makes them weaker than the recruits they were trained from.";
