...
<?php
	...
	if( !class_exists("ElfRecruitsMilitary")) {
		class ElfRecruitsMilitary extends MilitaryBase {
			var $picture = "scripts/military/elf/recruit.gif";
			var $MilitaryConst = NULL;
			
			function ElfRecruitsMilitary( $militaryID ) {
				$this->MilitaryConst = $GLOBALS['MilitaryConst'];
				$info = "Newly educated military for the elves. These soldiers should be used for training better military or exploring new land. Thieves and Magicians also need these basic skills of fight";
