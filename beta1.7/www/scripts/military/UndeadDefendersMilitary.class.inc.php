...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("UndeadDefendersMilitary")) {
		class UndeadDefendersMilitary extends MilitaryBase {
			var $picture = "recruite";
			var $MilitaryConst = NULL;
			
			function UndeadDefendersMilitary( $militaryID ) {
				...
				$this->MilitaryBase($militaryID, "Zombies", $info ,$type, $ticks, $cost, $strength);
			}
