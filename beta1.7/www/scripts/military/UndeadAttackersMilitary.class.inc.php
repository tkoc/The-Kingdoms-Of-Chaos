...
require_once("MilitaryConstants.class.inc.php");
	if( !class_exists("UndeadAttackersMilitary")) {
		class UndeadAttackersMilitary extends MilitaryBase {
			var $picture = "legions.gif";
			var $MilitaryConst = NULL;
			
			function UndeadAttackersMilitary( $militaryID ) {
				...
				$this->MilitaryBase($militaryID, "Skeletons", $info ,$type, $ticks, $cost, $strength);
			}
