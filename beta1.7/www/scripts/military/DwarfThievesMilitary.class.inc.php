...
<?php
	...
	if( !class_exists("DwarfThievesMilitary")) {
		class DwarfThievesMilitary extends MilitaryBase {
			var $picture = "bandits.gif";
			var $MilitaryConst = NULL;
			
			function DwarfThievesMilitary( $militaryID ) {
				$this->MilitaryConst = $GLOBALS['MilitaryConst'];
				$info = "The dwarven thieves, known as bandits. Not the best thieves around but not the worst either. Use this unit to spy on other provinces, and steel their resources. Keep in mind this unit will provide both attack and defending skills in a time of need. This military unit needs an additional training time of 24 days after finishing recruits training.";
