...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("OrcDefendersMilitary")) {
		class OrcDefendersMilitary extends MilitaryBase {
			var $picture = "scripts/military/orc/blackorc.gif";
			var $MilitaryConst = NULL;
			
			function OrcDefendersMilitary( $militaryID ) {
