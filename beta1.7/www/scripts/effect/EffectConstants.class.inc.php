...
//	var $ADD_MAX_MANA				= "addMaxMana";
	...
	// King Bonus Fix - Soptep: 11/01/2010
	var $ADD_GOLDKING_BONUS			= "addGoldKingBonus";
	var $ADD_FOODKING_BONUS			= "addFoodKingBonus";
	var $ADD_METALKING_BONUS		= "addMetalKingBonus";
