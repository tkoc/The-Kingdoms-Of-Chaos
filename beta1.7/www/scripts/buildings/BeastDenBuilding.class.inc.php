...
if( !class_exists( "BeastDenBuilding" ) ) {
require("BuildingBase.class.inc.php");

class BeastDenBuilding extends BuildingBase{
	...
	var $raceReq = array("Orc");
	var $scienceReq = array( "military" =>4, "infrastructure" => 4, "magic" => 0, "thievery" => 0 );
	function BeastDenBuilding( $buildingID ) {	
		$this->BuildingBase( $buildingID, 	 	// id	
							 "Beast den",	 	// name	
							 20, 					// ticks
							 2000, 				// gold
							 150, 				// metal	
							 "The beast den reduces your attack time by ".abs($this->addAttackTime)."% if you 
