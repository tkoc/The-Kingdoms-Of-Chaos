...
//**********************************************************************
//* Variables - New style definitions - Soptep: 12/02/2010
//**********************************************************************

// Path related info
$GLOBALS['rootPath'] = $rootPath;
$GLOBALS['languagePath'] = $rootPath."dokuwiki/data/pages/language/";
$GLOBALS['forumPath'] = $rootPath."worldforum/";

$GLOBALS['currentGamePath'] = $currentPath;
$GLOBALS['includesPath'] = $currentPath."includes/";
$GLOBALS['administrationPath'] = $currentPath."administration/";
$GLOBALS['scriptsPath'] = $currentPath."scripts/";

$GLOBALS['currentServerPath'] = $currentPath."tkoc.net_server/";
$GLOBALS['errorFileLog'] = $GLOBALS['currentServerPath']."error.log";
$GLOBALS['gameLog'] = $GLOBALS['currentServerPath']."game.log";



// Domain related info
$GLOBALS['currentGameDomain'] = $currentDomain;
$GLOBALS['rootDomain'] = $rootDomain;


//**********************************************************************
//* Variables - Old and Very old style definitions
//**********************************************************************

// paths (serverside) - Old GLOBAL Variables
$GLOBALS['path_root'] = $GLOBALS['path_home'] = $GLOBALS['path_www'] = $currentPath;
$GLOBALS['maindomain'] = $rootPath;
$GLOBALS['path_www_scripts']	= $GLOBALS['path_scripts'] = $currentPath.'scripts/';
$GLOBALS['path_language']		= $rootPath.'dokuwiki/data/pages/language/';
$GLOBALS['path_includes']		= $currentPath.'includes/';
$GLOBALS['path_www_administration'] 	= $currentPath.'administration/';
$GLOBALS['path_server']			= $currentPath."tkoc.net_server/";
$GLOBALS['FILE_ERROR_LOG']		= $GLOBALS['path_server'] . 'error.log';
$GLOBALS['FILE_LOG']			= $GLOBALS['path_server'] .'game.log';
...
// www-related stuff
$GLOBALS['domain_name'] 		= "";
$GLOBALS['path_domain_root'] 	= $currentDomain;
