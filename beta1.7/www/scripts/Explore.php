...
$explore = new Explore($database, $province);
// Needed to refresh the data in order to indicate the correct recruits to send after having done an explore - Soptep: 22/02/2010
$body = "<br />".$explore->handleExplore();
...
templateDisplay($province,$body,"../img/Cornerpictures/Explore_picture.jpg","<br>&nbsp<br><img src='../img/Leftpictures/Explore_leftpicture.jpg'>");	
?>
