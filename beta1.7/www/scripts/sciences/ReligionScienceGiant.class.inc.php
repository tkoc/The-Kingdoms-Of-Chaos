...
if( !class_exists( "ReligionScienceGiant" ) ) {
class ReligionScienceGiant extends ScienceBase {
		var $ADD_OFF       = "5";
		var $GROW_MANA      = 1;
		var $GROW_INFLUENCE = 1;
		var $raceReq = array( "Giant" );

		function ReligionScienceGiant ( $scienceID ) {
        	// id,name,ticks,gold,metal,description
			$this->ScienceBase( 
			$scienceID,"infrastructure", "Giant's Theology", 48, 5000000, 1500000,
			"Regain lost knowledge about the chaos Gods, gaining access to faster mana and influence regeneration and stronger offense. Available only to Giants.",
