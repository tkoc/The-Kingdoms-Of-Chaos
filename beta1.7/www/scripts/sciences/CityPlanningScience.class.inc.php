...
if( !class_exists( "CityPlanningScience" ) ) {
class CityPlanningScience extends ScienceBase {
		var $addedPeasantHousing = 10;

		function CityPlanningScience ( $scienceID ) {
        	// id,name,ticks,gold,metal,description
                	$this->ScienceBase( 
				$scienceID,"infrastructure", "City planning", 48, 5000000, 1500000,
				"Allows the construction of larger metropolises. <b>Increase population by $this->addedPeasantHousing %</b>
				",
				...
				/* Gives */
				array('military' =>8, "infrastructure" => 8, "magic" => 0, "thievery" => 2)
			);    
	        }
