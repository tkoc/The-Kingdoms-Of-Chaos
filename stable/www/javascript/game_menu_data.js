...
//	dqm__text_alignmentX = "left"
	...
	dqm__url0_0 = "../scripts/showProvince.php" + fcid
	...
	dqm__url1_0 = "../scripts/council.php" + fcid
	dqm__url1_1 = "../scripts/science.php" + fcid
	...
	dqm__url2_0 = "../scripts/Military.php" + fcid
	dqm__url2_1 = "../scripts/buildings.php" + fcid

    //Sub Menu 3

	dqm__sub_xy3 = "-130,24"
	dqm__sub_menu_width3 = 130
	dqm__subdesc3_0 = "World Forum"
	dqm__subdesc3_1 = "Kingdom Forum"
	dqm__subdesc3_2 = "Messages"
	dqm__subdesc3_3 = "Kingdom"
	dqm__subdesc3_4 = "Trade"
	dqm__subdesc3_5 = "Kingdom News"
	dqm__subdesc3_6 = "Politics"
	dqm__subdesc3_7 = "Statistics"
	//dqm__subdesc3_3 = "Chat"
	//dqm__subdesc3_8 = "HEROES of chaos"
	...
	dqm__url3_0 = "../worldforum"
	dqm__url3_1 = "../scripts/kingdomForum.php" + fcid
	dqm__url3_2 = "../scripts/message.php" + fcid
	dqm__url3_3 = "../scripts/report.php" + fcid
	dqm__url3_4 = "../scripts/aid.php" + fcid
	dqm__url3_5 = "../scripts/showKingdomNews.php" + fcid
	dqm__url3_6 = "../scripts/politics.php" + fcid
	dqm__url3_7 = "http://stats.tkoc.net"
	//dqm__url3_3 = "../administration/Webchat.php" + fcid
	//dqm__url3_8 = "../thoc/index.html" + fcid
	...
	dqm__url4_0 = "../scripts/Attack.php" + fcid
	dqm__url4_1 = "../scripts/thievery.php" + fcid
	dqm__url4_2 = "../scripts/magic.php" + fcid
	dqm__url4_3 = "../scripts/Explore.php" + fcid
	//dqm__url4_4 = "../scripts/beasts.php" + fcid
