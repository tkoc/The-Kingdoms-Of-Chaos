...
/* TempleBuilding class.
 * 
 * This class will handle all functions of a TempleBuilding requires BuildingBase.class.inc.php
...
if( !class_exists( "TempleBuilding" ) ) {
require("BuildingBase.class.inc.php");

class TempleBuilding extends BuildingBase{
	...
	var $raceReq = array( "Human", "Elf", "Dwarf", "Orc", "Giant" ); // races that have this building
	var $picture = "temple.jpg";
	function TempleBuilding( $buildingID ) {	
		$this->BuildingBase( $buildingID, 	// id	
							 "Temple", 		// name
							 20, 			// ticks
							 1500, 			// gold
							 0, 			// metal	
							 "The temple adds $this->goldIncome to your gold income, 
