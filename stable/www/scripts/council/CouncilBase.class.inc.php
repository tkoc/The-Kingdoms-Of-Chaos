...
<tr><td ALIGN=LEFT>Housing</td><td ALIGN=LEFT>'.round(($eff->getEffect($GLOBALS['effectConstants']->ADD_PEASANT_HOUSING,$pid)-1)*100,2).'%</td></tr>
	...
	function showCost () {
		return "<table><tr><td>gold:</td><td>" . writeChaosNumber($this->costToHire['gold']) . "</td></tr>" .
					"<tr><td>metal:</td><td>". writeChaosNumber($this->costToHire['metal']) . "</td></tr>" .
				"<tr><td>food:</td><td>". writeChaosNumber($this->costToHire['food']) . "</td></tr>" .
				"<tr><td>peasants:</td><td>" . writeChaosNumber($this->costToHire['peasants']) . "</td></tr>
				</table>";
	}

	function showUpkeep () {
		return "<table><tr><td>gold:</td><td>" . writeChaosNumber($this->upkeep['gold']) . "</td></tr>" .
				"<tr><td>metal:</td><td>". writeChaosNumber($this->upkeep['metal']) . "</td></tr>" .
				"<tr><td>food:</td><td>". writeChaosNumber($this->upkeep['food']) . "</td></tr>" .
				"<tr><td>peasants:</td><td>" . writeChaosNumber($this->upkeep['peasants']) . "</td></tr>
				</table>";
	}
