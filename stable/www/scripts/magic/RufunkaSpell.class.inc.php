...
/* Rufunka class is the class of a spell, derived from SpellBase.
 *
...
if( !class_exists( "RufunkaSpell" ) ) {

	class RufunkaSpell extends SpellBase {
		var $addAttack = 25;		// give % better attack
		var $mana = 40;
		...
		function RufunkaSpell( $sID ) {
			$this->SpellBase( 	$sID, 				// spell ID
							"Rufunka",								// name
							50,					// gold cost pr acre
							10,					// metal cost pr acre
							8,					// food cost pr acre
							3.5,				// needed wizards pr acre
							2,					// cast on self only
							1,					// type indirect
							"Rufunka gives the target $this->addAttack% better attack for the duration of the spell 
							and can only be used by elves.",//description
							false);									// picture
		}
		function addAttack() {
