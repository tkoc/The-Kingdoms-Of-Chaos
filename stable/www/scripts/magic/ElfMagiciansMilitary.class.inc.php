...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("ElfMagiciansMilitary")) {
		class ElfMagiciansMilitary extends MilitaryBase {
			var $picture = "scripts/military/elf/wizard.gif";
			var $MilitaryConst = NULL;
			
			function ElfMagiciansMilitary( $militaryID ) {

				$this->MilitaryConst = $GLOBALS['MilitaryConst'];

				$info = "As we all know, magic is a very useful resource, especially for the elves that probably got the best magicians in this world. It helps both in times of peace, and in times of war. Since the wizards once where recruits, they still know the basics of fighting and be quite usefull in ordinary fights, but as for thieves: remember that attacking and defending are not the speciality of the magicians. This military unit needs an additional training time of 24 days after finishing recruits training";
