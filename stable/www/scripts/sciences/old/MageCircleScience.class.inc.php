...
class MageCircleScience extends ScienceBase {
        ...
        function MageCircleScience( $scienceID ) {
                ...
                $this->ScienceBase( $scienceID,"magic", "Mage circle", 28, 75000, 0,
		"In ledgends long forgotten, there are tales of wizards linking in a powerful circle to preform witchcraft.  
		Your archmages say that this knowledge will reduce the number of wizards required to cast a spell.. <b>This will 
		effectivly reduce wizard requirements by 25%</b>",
/* requires */
...
array("military" => 0, "infrastructure" => 0, "magic" => 1, "thievery" => 0)
        ...
        function getScienceEffect ($value) {
                if ($value==SCI_EFF_MAGIC_COST_WIZ)
                        return $this->EFFECT;
		else return 1.00;
        }
