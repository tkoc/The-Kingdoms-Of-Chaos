...
class ApocalypseScience extends ScienceBase {
        ...
        function ApocalypseScience( $scienceID ) {
                ...
                $this->ScienceBase( $scienceID, "magic" ,"Apocalypse", 240, 10000001, 5000000,"
Our wise men have only heard rumours about this knowledge.  The effect is still unknown...
",
/* requires */
array('military' =>16, "infrastructure" => 8, "magic" => 8, "thievery" =>8),
/* Gives */
array("military" => 128, "infrastructure" => 128, "magic" => 128, 
"thievery" => 128)
