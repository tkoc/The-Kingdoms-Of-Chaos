...
<?php
	...
	if( !class_exists("ElfDefendersMilitary")) {
		class ElfDefendersMilitary extends MilitaryBase {
			var $picture = "scripts/military/elf/archer.gif";
			var $MilitaryConst = NULL;
			
			function ElfDefendersMilitary( $militaryID ) {
