...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("GiantThievesMilitary")) {
		class GiantThievesMilitary extends MilitaryBase {
			var $picture = "thieves.gif";
			var $MilitaryConst = NULL;
			
			function GiantThievesMilitary( $militaryID ) {

				$this->MilitaryConst = $GLOBALS['MilitaryConst'];
				$ticks = 24;
				$info = "Only the smallest of giants are suited for thieves, this makes them weaker than their military brethren. They require an additional $ticks days of training.";
