...
<?php
	...
	if( !class_exists("PaladinsMilitary")) {
		class PaladinsMilitary extends MilitaryBase {
			var $picture = "paladins.gif";
			var $MilitaryConst = NULL;
				
			function PaladinsMilitary( $militaryID ) {
				$this->MilitaryConst = $GLOBALS['MilitaryConst'];
				$info = "The paladin is of the elite branch in your military, and can be used both for attacking and defending. This military is better than specialists at both";
