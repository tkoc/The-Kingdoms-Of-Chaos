...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("OrcAttackersMilitary")) {
		class OrcAttackersMilitary extends MilitaryBase {
			var $picture = "scripts/military/orc/wolfrider.gif";
			var $MilitaryConst = NULL;
			
			function OrcAttackersMilitary( $militaryID ) {
				...
				$this->MilitaryBase($militaryID, "Wolf Riders", $info ,$type, $ticks, $cost, $strength);
			}
