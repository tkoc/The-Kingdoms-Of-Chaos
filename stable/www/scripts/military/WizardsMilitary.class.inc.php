...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("WizardsMilitary")) {
		class WizardsMilitary extends MilitaryBase {
			var $picture = "wizards.gif";
			var $MilitaryConst = NULL;
			
			function WizardsMilitary( $militaryID ) {

				$this->MilitaryConst = $GLOBALS['MilitaryConst'];

				$info = "As we all know, magic is a very useful resource. It helps both in times of peace, and in times of war. Since the wizards once where recruits, they still know the basics of fighting and be quite usefull in ordinary fights";
