...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("HumanMagiciansMilitary")) {
		class HumanMagiciansMilitary extends MilitaryBase {
			var $picture = "scripts/military/human/wizard.gif";
			var $MilitaryConst = NULL;
			
			function HumanMagiciansMilitary( $militaryID ) {

				$this->MilitaryConst = $GLOBALS['MilitaryConst'];

				$info = "As we all know, magic is a very useful resource. It helps both in times of peace, and in times of war. Since the wizards once where recruits, they still know the basics of fighting and be quite usefull in ordinary fights. This military unit needs an additional trainingtime of 24 days after finishing recruits training.";
				$type = $this->MilitaryConst->WIZARDS;
				$ticks = 24;
				$cost = array("gold"=>1000, "metal"=>0, "food"=>100);
				$strength = array("attack"=>1, "defense"=>1);
				$this->MilitaryBase($militaryID, "Wizards", $info ,$type, $ticks, $cost, $strength);
