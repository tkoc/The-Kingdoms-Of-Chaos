...
<?php
	...
	if( !class_exists("RecruitsMilitary")) {
		class RecruitsMilitary extends MilitaryBase {
			var $picture = "recruite";
			var $MilitaryConst = NULL;
			
			function RecruitsMilitary( $militaryID ) {
				$this->MilitaryConst = $GLOBALS['MilitaryConst'];
				$info = "Newly educated military. These soldiers should be used for training better military or exploring new land. Thieves and Wizards also need these basic skills of fight";
