...
require_once("MilitaryBase.class.inc.php");
	...
	if( !class_exists("DwarfDefendersMilitary")) {
		class DwarfDefendersMilitary extends MilitaryBase {
			var $picture = "recruite";
			var $MilitaryConst = NULL;

			function DwarfDefendersMilitary( $militaryID ) {
				...
				$ticks = 18;
				$cost = array("gold"=>700, "metal"=>0, "food"=>50);
				$strength = array("attack"=>1, "defense"=>4);
				$this->MilitaryBase($militaryID, "Dwarven Defender", $info ,$type, $ticks, $cost, $strength);
			}
