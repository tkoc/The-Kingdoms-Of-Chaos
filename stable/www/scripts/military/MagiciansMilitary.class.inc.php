...
<?php
	...
	if( !class_exists("MagiciansMilitary")) {
		class MagiciansMilitary extends MilitaryBase {
			var $picture = "wizards.gif";
			var $MilitaryConst = NULL;
			
			function MagiciansMilitary( $militaryID ) {

				$this->MilitaryConst = $GLOBALS['MilitaryConst'];

				$info = "As we all know, magic is a very useful resource, especially for the elves that probably got the best magicians in this world. It helps both in times of peace, and in times of war. Since the wizards once where recruits, they still know the basics of fighting and be quite usefull in ordinary fights";
