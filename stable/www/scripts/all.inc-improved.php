...
<table border="0">
		<div class="game-header">
			<div class="cornerpic" style="position:absolute;">
				<img src="<?php echo $cornerpic;?>" />
			</div>
			<div class="province-info-header" style="margin-left:240px;">
				<div class="networth">
		   ...
		   <div class="time-tick" style="margin-left:240px;">
				<?php
				...
				echo "
					<span class='left'>$day day of the $month Month of the $year year in the $era era</span>
					<span class='right'>Next tick in: <b>$nextTick[nextTick]</b> hours</span>
				";
				?>
		   </div>
