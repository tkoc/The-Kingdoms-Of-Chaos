...
if (isset($_POST['step']))
	switch ( $_POST['step']) {
		...
		break;
		case 'sendOut':
			$html .= $thievery->thieveryEffect($_POST['selectOperation'],$_REQUEST['selectProvince']) . "<br>&nbsp";
		break;
	}
...
will drop, and for each day you rest your influence will rise again.  Remember that your success depends both on the number of thieves you have and your influence level.
<br>&nbsp</center>
</td></tr></table>
';

$html .= '<center>
</td><td width="300" valign=TOP><img src="../img/space.gif" width="300" height="150">
</td><tr>
