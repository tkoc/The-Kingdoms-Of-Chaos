...
/* cheaters.php
 * 
 * This file contains code to find and delete cheaters.
 *
...
require_once( "Cheater.class.inc.php" );

if ((intval($GLOBALS['user']->access) & $GLOBALS['constants']->USER_GAME_ADMIN) )
   $cheater = new Cheater( $database ); 
else die("tkoc.net");

$html = $cheater->getHtmlDisplay();   

AdminTemplateDisplay("Game Cheaters",$user,$html);
