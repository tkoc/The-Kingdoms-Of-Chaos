...
function setupMenuContext()
{
	...
	// Hack to get dynamically the game url, working both for localhost or online - By Soptep: 31/12/2009
	$domain = str_replace ("worldforum/index.php", "", $scripturl);
	...
	if (($menu_buttons = cache_get_data('menu_buttons-' . implode('_', $user_info['groups']) . '-' . $user_info['language'], $cacheTime)) === null || time() - $cacheTime <= $modSettings['settings_updated'])
	{
		$buttons = array(
			...
			'game' => array(
				'title' => "Game",
				'href' => $domain."scripts/showProvince.php",
				'show' => true,
				'sub_buttons' => array(
				),
			),
			...
			'profile' => array(
				...
				'show' => false, //$context['allow_edit_profile'],
				'sub_buttons' => array(
					'summary' => array(
						'title' => $txt['summary'],
						'href' => $scripturl . '?action=profile',
